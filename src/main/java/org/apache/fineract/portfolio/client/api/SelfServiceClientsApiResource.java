...
public class SelfServiceClientsApiResource {
  ...
  @ApiResponse(
      ...
      content =
          @Content(
              schema =
                  @Schema(
                      implementation = ClientsApiResourceSwagger.GetClientsTemplateResponse.class)))
  public String retrieveTemplate(
      @Context final UriInfo uriInfo,
      @Parameter(description = "officeId") @QueryParam("officeId") final Long officeId,
      @QueryParam("commandParam") @Parameter(description = "commandParam")
          final String commandParam,
      @DefaultValue("false")
          @QueryParam("staffInSelectedOfficeOnly")
          @Parameter(description = "staffInSelectedOfficeOnly")
    ...
    if (CommandParameterUtil.is(commandParam, "close")) {
      ...
      clientData =
          clientReadPlatformService.retrieveAllNarrations(
              ClientApiConstants.CLIENT_WITHDRAW_REASON);
    } else {
      clientData =
          clientTemplateReadPlatformService.retrieveTemplate(officeId, staffInSelectedOfficeOnly);
    }
  ...
  @ApiResponse(
      ...
      content =
          @Content(
              schema =
                  @Schema(implementation = ClientsApiResourceSwagger.GetClientsResponse.class)))
  public String retrieveAll(
      ...
      @QueryParam("underHierarchy") @Parameter(description = "underHierarchy")
  ...
  @ApiResponse(
      ...
      content =
          @Content(
              schema =
                  @Schema(
                      implementation = ClientsApiResourceSwagger.GetClientsClientIdResponse.class)))
  ...
  @RequestBody(
      ...
      content =
          @Content(
              schema =
                  @Schema(implementation = ClientsApiResourceSwagger.PostClientsRequest.class)))
  @ApiResponse(
      responseCode = "200",
      description = "OK",
      content =
          @Content(
              schema =
                  @Schema(implementation = ClientsApiResourceSwagger.PostClientsResponse.class)))
  ...
  @RequestBody(
      ...
      content =
          @Content(
              schema =
                  @Schema(
                      implementation = ClientsApiResourceSwagger.PutClientsClientIdRequest.class)))
  @ApiResponse(
      responseCode = "200",
      description = "OK",
      content =
          @Content(
              schema =
                  @Schema(
                      implementation = ClientsApiResourceSwagger.PutClientsClientIdResponse.class)))
  ...
  @RequestBody(
      ...
      content =
          @Content(
              schema =
                  @Schema(
                      implementation = ClientsApiResourceSwagger.PostClientsClientIdRequest.class)))
  @ApiResponse(
      responseCode = "200",
      description = "OK",
      content =
  ...
  @Operation(
      summary = "Download client template for bulk import",
  ...
  @ApiResponse(responseCode = "400", description = "Bad Request")
  public String retrieveObligeeDetails(
      @PathParam("externalId") final String externalId, @Context final UriInfo uriInfo) {
  ...
  @Operation(
      ...
      description = "Retrieve client transfer template using the client external Id")
  @ApiResponse(
      responseCode = "200",
      description = "OK",
      content =
  ...
  private ClientData retrieveClientData(
      final Long clientId, final boolean staffInSelectedOfficeOnly, final boolean isTemplate) {
    ClientData clientData = clientReadPlatformService.retrieveOne(clientId);
    if (isTemplate) {
      final ClientData templateData =
          clientTemplateReadPlatformService.retrieveTemplate(
              clientData.getOfficeId(), staffInSelectedOfficeOnly);
  ...
  private CommandWrapper evaluateCommand(
      final Long clientId, final String commandParam, final CommandWrapperBuilder builder) {
  ...
  private String retrieveClient(
    ...
    final ClientData clientData =
        retrieveClientData(clientId, staffInSelectedOfficeOnly, settings.isTemplate());
    return toApiJsonSerializer.serialize(
        settings, clientData, ClientApiConstants.CLIENT_RESPONSE_DATA_PARAMETERS);
  }
  ...
  private String retrieveClientAccounts(
      Long clientId, final String externalId, final UriInfo uriInfo) {
    context.authenticatedUser().validateHasReadPermission(ClientApiConstants.CLIENT_RESOURCE_NAME);
    ExternalId clientExternalId = ExternalIdFactory.produce(externalId);
    clientId = getResolvedClientId(clientId, clientExternalId);
    ...
    final ApiRequestJsonSerializationSettings settings =
        apiRequestParameterHelper.process(uriInfo.getQueryParameters());
    return clientAccountSummaryToApiJsonSerializer.serialize(
        settings, clientAccount, ClientApiConstants.CLIENT_ACCOUNTS_DATA_PARAMETERS);
  }

  private String applyCommandOverClient(
      Long clientId, final String externalId, final String command, final String jsonPayload) {
    ExternalId clientExternalId = ExternalIdFactory.produce(externalId);
    clientId = getResolvedClientId(clientId, clientExternalId);
