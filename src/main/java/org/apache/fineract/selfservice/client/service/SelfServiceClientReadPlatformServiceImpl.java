...
public class SelfServiceClientReadPlatformServiceImpl implements SelfServiceClientReadPlatformService {
    ...
    @Override
    public Page<ClientData> retrieveAll(final SelfServiceSearchParameters searchParameters) {
    ...
    private String buildSqlStringFromClientCriteria(String schemaSql, final SelfServiceSearchParameters searchParameters, List<Object> paramList) {
