 ...
 */
public class SelfServicePasswordResetRequiredException extends AuthenticationException {

    private final SelfServiceAuthenticatedUserData authenticatedUserData;

    public SelfServicePasswordResetRequiredException(SelfServiceAuthenticatedUserData authenticatedUserData) {
        super("Password reset required");
        this.authenticatedUserData = authenticatedUserData;
    }

    public SelfServiceAuthenticatedUserData getAuthenticatedUserData() {
